...
import com.example.myapplication1.StateAdapter2;
import com.example.myapplication1.StateAdapter3;
import com.example.myapplication1.StateAdapterNowD;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(MainActivity2.ArrPlan.size()==0){
            ...
            for (int i = 0; i < MainActivity2.ArrPlan.size(); i++) {
                ...
                states.add(new newPlan(MainActivity2.ArrPlan.get(i).getSub(), r, MainActivity2.ArrPlan.get(i).gettodaylearned(), i));
            }
            if (states.size() == 0) {
                ...
                if(day1==dayOfMonth&&month1==month&&year==year1) {
                    ...
                    for (int i = 0; i < MainActivity2.ArrPlan.size(); i++) {
                        int r = MainActivity2.ArrPlan.get(i).search_nom_plan(dayOfMonth, month, year);
                            states1.add(new newPlan(MainActivity2.ArrPlan.get(i).getSub(), r, MainActivity2.ArrPlan.get(i).gettodaylearned(), i));
                    }
                    im.setVisibility(View.VISIBLE);
                    if (states1.size() == 0) {
                        text.setText("Нет плана на данную дату");
                    ...
                    for (int i = 0; i < MainActivity2.ArrPlan.size(); i++) {
                        ...
                        if (r != -1) {
                            if(d.before(d1)) {
                                states1.add(new newPlan(MainActivity2.ArrPlan.get(i).getSub(), -1, MainActivity2.ArrPlan.get(i).plan_to_day.get(r).getSize_of_quetion(), i));
                            }else {
                                states1.add(new newPlan(MainActivity2.ArrPlan.get(i).getSub(), r, MainActivity2.ArrPlan.get(i).plan_to_day.get(r).getSize_of_quetion(), i));
                            }
                            ...
                            if((MainActivity2.ArrPlan.get(i).getDay()==dayOfMonth)&&(MainActivity2.ArrPlan.get(i).getMonth()==month)&&(MainActivity2.ArrPlan.get(i).getYear()==year)) {
                                states1.add(new newPlan(MainActivity2.ArrPlan.get(i).getSub(), r, "-10", i));
                            }
                        }
                    }
                    im.setVisibility(View.VISIBLE);
